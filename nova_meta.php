...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $_SESSION['message'] = ['type' => 'success', 'text' => 'Nova meta criada com sucesso!'];
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="form-card">
                ...
                <form action="nova_meta.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descricao" name="descricao" class="form-control" rows="4"><?= htmlspecialchars($descricao) ?></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <input type="date" id="prazo" name="prazo" class="form-control" value="<?= htmlspecialchars($prazo) ?>" required>
                            </div>
                        </div>
                    </div>
                     <div class="form-group">
